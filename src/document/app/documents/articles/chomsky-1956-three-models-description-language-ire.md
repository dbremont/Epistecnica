...
- What is the meaning of the phrase **'description of language'** in this paper?
...
- Markovian Sources,
- Re-writing Systems / Post-Rewriting Systems /
- Finite Automata - Transformation Grammar (This is the only model that makes sense to Chomsky to describe language; the other ones are wrong descriptive models).
...
- What is the grammar of language?
